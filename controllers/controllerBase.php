<?php
    class ControllerBase{
        ...
        public function loginUser($datos){
          $user = new User();
        $result = $user->validateLogin($datos['email'], $datos['password']);
        ...
        public function formReservas(){
            $this->verPaginaInicio('views/html/auth/formReservas.php');
        }

        public function logout(){
            $this->verPaginaInicio('views/html/auth/cerrarsesion.php');
        }
